...
public class HomeFragment extends Fragment implements Serializable {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = rootView.findViewById(R.id.food_items);
        ...
        list = new ArrayList<>();
        recyclerViewAdapter = new RecyclerViewAdapter(getContext(), list, new RecyclerViewAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(FoodItem foodItem) {
                Intent intent = new Intent(getContext(),activityfooddes.class);
